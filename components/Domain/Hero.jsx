...
import Typewritter from '../../images/search-bar.png'
      ...
      <div className="container pt-5 pb-5">
        <div className="row">
          <div className="col-md-6 blog-baneer-column-left">
            <h1 className='pt-5' style={{width:"101%"}}>Re<span style={{color:"#f8cc08"}}>search</span> Do<span style={{color:"#6eac54"}}>main</span></h1>
