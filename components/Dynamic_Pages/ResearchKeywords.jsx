...
const ResearchKeywords = ({ type, subtype, slug }) => {
        ...
        <>
            ...
            <div className="unit-5 overlay topics-img">
                <div className="container text-center">
                    <h1 className="mb-0">Research Keywords</h1>
                    <p className="mb-0 unit-6">Home<span className="sep"><AiOutlineRight /></span><span>Research Keywords</span></p>
                </div>
            </div>
                ...
                <div className="mx-lg-5 mx-2 mx-md-3">
                    <div className="row mx-auto justify-content-start text-left mb-3">
                        <div className="col-md-12" >
                            <h5 className="font-weight-semibold text-black site-section-subheading">Search Research Keywords</h5>
                        </div>
                    </div>
                        ...
                        <div className="col-md-6">
                            <div className="newsletter-box topic-search text-center">
                                <div className="input-group col-lg-12 topics-section" style={{ border: "none", padding: "1px 10px", borderRadius: "30px", height: "45px", boxShadow: "1px 4px 11px 0px #57c8f16e" }}>
                                    <input type="search" className="form-control topic-form" value={searchTerm ? slug : ""} placeholder="Search Your Research Topic" required onChange={(e) => {
                                                    ...
                                                    <div className="col-lg-9 col-md-7 mb-4 mb-md-0 px-0 px-md-2">
                                                        <Link href={`/domain/${blog.slug}`}><a>
                                                            <div className="job-post-item-header d-flex align-items-center">
                                                                <h6 className="mr-3 text-black font-weight-bold" style={{ fontSize: "1.2rem" }}>{blog.title}</h6>
                                                            </div>
                                                        </a></Link>
                                                        <div className="job-post-item-body row mx-auto mb-2">
                                                                    ...
                                                                    return (
                                                                        <>
                                                                            <Link href={`/keywords/${item.slug}`} ><a>
                                                                                <h6 key={key} className="mx-2 mt-2" style={{ color: "grey" }}>
                                                                                    <FaTag className="mr-1 text-muted" />{item.title}
                                                                                </h6>
                                                                            </a></Link>
                                                                        </>
                                                                    )
